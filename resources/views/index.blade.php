                    ...
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100">
                            ...
                            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                                ...
                                <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">{{ $slide->title }}
                                </h2>
                                <a href="{{ $slide->link }}"
        ...
        <div class="container mw-1620 bg-white border-radius-10">
            ...
            <section class="products-grid container">
                ...
                <div class="row" id="product-list">
                    @include('partials.featured-products', ['fproducts' => $fproducts])
                </div>

                @if ($fproducts->hasMorePages())
                    <div class="text-center mt-4">
                        <button id="load-more" class="btn-link btn-link_lg default-underline text-uppercase fw-medium"
                            data-page="2">
                            Load More
                        </button>
                    </div>
