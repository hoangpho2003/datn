    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
                action="{{ route('admin.products.update') }}" id="productForm">
                @csrf
                @method('PUT')
                        ...
                        <div class="upload-image mb-16">
                            @if ($product->images)
                                @foreach (explode(',', $product->images) as $img)
                                    <div class="item gitems" data-img="{{ trim($img) }}">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#gFile").on("change", function() {
                ...
                $.each(gphotos, function(key, val) {
                    $("#galUpload").prepend(
                        `<div class="item gitems"><img src="${URL.createObjectURL(val)}" class="effect8" alt=""></div>`
                    );
                });
            });
        });
        ...
        $(document).on('click', '.remove-image', function() {
            const imgDiv = $(this).closest('.gitems');
            const imgName = imgDiv.data('img');
